    ...
    #reate_clock -add -name sys_clk_pin -period 8.00 -waveform {0 4} [get_ports { clk }];#set
    ...
    ## LEDs
    set_property -dict { PACKAGE_PIN R14    IOSTANDARD LVCMOS33 } [get_ports { led_debug_0[0] }]; #IO_L6N_T0_VREF_34 Sch=LED0
    set_property -dict { PACKAGE_PIN P14    IOSTANDARD LVCMOS33 } [get_ports { led_debug_0[1] }]; #IO_L6P_T0_34 Sch=LED1
    set_property -dict { PACKAGE_PIN N16    IOSTANDARD LVCMOS33 } [get_ports { led_debug_0[2] }]; #IO_L21N_T3_DQS_AD14N_35 Sch=LED2
    set_property -dict { PACKAGE_PIN M14    IOSTANDARD LVCMOS33 } [get_ports { led_debug_0[3] }]; #IO_L23P_T3_35 Sch=LED3
    
    ## Buttons
    set_property -dict { PACKAGE_PIN D19    IOSTANDARD LVCMOS33 } [get_ports { btn_phys_0[0] }]; #IO_L4P_T0_35 Sch=BTN0
    set_property -dict { PACKAGE_PIN D20    IOSTANDARD LVCMOS33 } [get_ports { btn_phys_0[1] }]; #IO_L4N_T0_35 Sch=BTN1
