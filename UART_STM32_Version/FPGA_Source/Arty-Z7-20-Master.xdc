    ...
    ## Buttons
    set_property -dict { PACKAGE_PIN D19    IOSTANDARD LVCMOS33 } [get_ports { btns[0] }]; #IO_L4P_T0_35 Sch=BTN0
...
set_property ALLOW_COMBINATORIAL_LOOPS TRUE \
  [get_nets -hier -regexp {.*osc_cell.*/(xor1|xor2|and1|and2)(\[.*\])?$}]
...
# ==== (Tùy chọn) bạn đang MARK_DEBUG - không ảnh hưởng DRC, giữ nếu dùng ILA ====
 set_property MARK_DEBUG true [get_nets -hierarchical *random_bit*]
 set_property MARK_DEBUG true [get_nets -hierarchical *osc_jitter[0]*]
 set_property MARK_DEBUG true [get_nets -hierarchical *osc_jitter[1]*]
 set_property MARK_DEBUG true [get_nets -hierarchical *osc_jitter[2]*]
 set_property MARK_DEBUG true [get_nets -hierarchical *osc_jitter[3]*]